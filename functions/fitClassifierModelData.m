...
% output file name
output_filename = [network_param.savedir 'matfiles/' 'classifier_' file_tag '_f2f' f2f_type 'discExp_pw' num2str(100*pulse_width)];
...
x_res = load([matfile_dir '/sim_data_' file_tag '_f2f' f2f_type 'discExp_pw' num2str(100*pulse_width) '.mat']);
